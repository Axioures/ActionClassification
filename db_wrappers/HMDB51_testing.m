function [] = HMDB51_testing(params, db_params)
	...
	for s=1:db_params.num.splits
		...
		parsave(fullfile(params.paths.testing, 'results.mat'), accuracy, confusion_matrix, classes, probs, db_params.split(s).testing_annotation);
	end
end
